...
export default function Home() {
  ...
  // ✅ initialize clicks from localStorage
  useEffect(() => {
  ...
  const handleClick = () => {
    ...
    if (!success) return
    const updatedClicks = getClicksLeft()

    setClicksLeft(updatedClicks)
      ...
      <div id="center-content-home">
        ...
        {step === "card" && (
          <>
            ...
            <button
              className="cta-card-home m-5 text-gray-600 hover:cursor-pointer hover:text-white transition duration-300"
              onClick={() => {
